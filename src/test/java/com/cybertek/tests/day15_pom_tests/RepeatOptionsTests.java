...
public class RepeatOptionsTests extends TestBase {
    ...
    public void RepeatRadioButtonTest(){
        ...
        calendarEventsPage.waitUntilLoaderScreenDisappear();// hata aldigin yere bunu ekle
        BrowserUtils.waitFor(2);
        calendarEventsPage.createCalendarEvent.click();
        //Click on repeat
        CreateCalendarEventsPage createCalendarEventsPage = new CreateCalendarEventsPage();
        calendarEventsPage.waitUntilLoaderScreenDisappear(); // ben buraya ekledim ve hata düzeldi
