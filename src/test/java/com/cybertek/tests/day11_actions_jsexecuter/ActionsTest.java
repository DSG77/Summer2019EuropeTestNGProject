...
import org.testng.annotations.Test;
    public class ActionsTest {
        ...
        public void DragAndDropChaining() {
            ...
            actions.moveToElement(source).clickAndHold().moveToElement(target).pause(2000).release().build().perform(); //.pause(2000) da araya koyabilirsin
        // http://practice.cybertekschool.com/jqueryui/menu   buradan praktik yapabiliriz
